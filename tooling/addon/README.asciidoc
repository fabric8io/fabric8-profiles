== fabric8-profiles-forge
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The fabric8-profiles-forge addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>fabric8-profiles-forge</artifactId>
