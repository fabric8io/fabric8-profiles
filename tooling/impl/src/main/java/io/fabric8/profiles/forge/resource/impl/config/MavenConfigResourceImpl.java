 ...
 */
public class MavenConfigResourceImpl extends AbstractConfigResourceImpl<MavenConfigDTO> implements MavenConfigResource {

    public MavenConfigResourceImpl(ResourceFactory factory, Resource<?> parent, MavenConfigDTO member) {
