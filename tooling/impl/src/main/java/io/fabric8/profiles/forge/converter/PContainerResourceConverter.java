 ...
 */
public class PContainerResourceConverter extends AbstractConverter<String, PContainerResource> implements Converter<String, PContainerResource> {
    ...
    public PContainerResourceConverter() {
        super(String.class, PContainerResource.class);
    }
